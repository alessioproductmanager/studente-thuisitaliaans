...
FRASI = {
    ...
    "crediti_tit": 'Crediti fotografici', "crediti_link": 'crediti completi',
        ...
        "scatti": ['lettore', 'percorso', 'tappa', 'edicola', 'mappa', 'metodo'], "store": 'iOS App Store', "stelle": 'Valutazione cinque stelle su App Store',
    },
    "en": {
    ...
    "crediti_tit": 'Photo credits', "crediti_link": 'full credits',
        ...
        "scatti": ['reader', 'path', 'step', 'newsstand', 'map', 'method'], "store": 'iOS App Store', "stelle": 'Five-star rating on the App Store',
    },
    "nl": {
    ...
    "crediti_tit": 'Fotocredits', "crediti_link": 'volledige credits',
        ...
        "scatti": ['lezer', 'traject', 'stap', 'kiosk', 'kaart', 'methode'], "store": 'iOS App Store', "stelle": 'Vijf sterren in de App Store',
    },
    "de": {
    ...
    "crediti_tit": 'Bildnachweis', "crediti_link": 'vollständige Nachweise',
        ...
        "scatti": ['Leser', 'Lernpfad', 'Etappe', 'Kiosk', 'Karte', 'Methode'], "store": 'iOS App Store', "stelle": 'Fünf Sterne im App Store',
    },
    "fr": {
    ...
    "crediti_tit": 'Crédits photo', "crediti_link": 'crédits complets',
        ...
        "scatti": ['lecteur', 'parcours', 'étape', 'kiosque', 'carte', 'méthode'], "store": 'iOS App Store', "stelle": "Cinq étoiles sur l'App Store",
    },
    "es": {
    ...
    "crediti_tit": 'Créditos fotográficos', "crediti_link": 'créditos completos',
        ...
        "scatti": ['lector', 'itinerario', 'etapa', 'quiosco', 'mapa', 'método'], "store": 'iOS App Store', "stelle": 'Cinco estrellas en la App Store',
    },
    "pl": {
    ...
    "crediti_tit": 'Źródła zdjęć', "crediti_link": 'pełne źródła',
        ...
        "scatti": ['czytnik', 'ścieżka', 'etap', 'kiosk', 'mapa', 'metoda'], "store": 'iOS App Store', "stelle": 'Pięć gwiazdek w App Store',
    },
}
...
.app-mini{margin-top:18px;margin-bottom:18px;display:grid;grid-template-columns:242px 1fr;gap:22px;
...
.app-mini-scatti{position:relative;height:268px}
.app-mini-scatti .app-tel{position:absolute;top:50%;width:122px;display:block}
...
.app-mini-scatti .app-tel:nth-of-type(1){left:0;transform:translateY(-50%) rotate(-4.5deg) scale(.94);z-index:1}
.app-mini-scatti .app-tel:nth-of-type(2){left:58px;transform:translateY(-50%);z-index:3}
.app-mini-scatti .app-tel:nth-of-type(3){left:118px;transform:translateY(-50%) rotate(4.5deg) scale(.94);z-index:2}
...
@media(max-width:560px){
  .app-mini{grid-template-columns:182px 1fr;gap:16px;padding:16px}
  .app-mini-scatti{height:204px}
  .app-mini-scatti .app-tel{width:92px}
  .app-mini-scatti .app-tel:nth-of-type(2){left:44px}
  .app-mini-scatti .app-tel:nth-of-type(3){left:90px}
  .app-mini h2{font-size:18px}
}
@media(max-width:400px){
  .app-mini{grid-template-columns:1fr;justify-items:center;text-align:center}
  .app-mini-scatti{width:214px}
}
