...
## Secondo giro · 150–155 (8 agosto, sera)

| # | Cosa | Contatore |
|---|---|---|
| 150 | blog in ordine di data (indice + 6 categorie; 4 erano già giuste) | 217+72+22 card |
| 151 | stelline ATTACCATE al bottone (dopo il prezzo) su grammatica, esercizi e blog · copy dei capitoli grammatica unificata con quella dell'indice della stessa lingua ("Ogni argomento, un mondo" ecc., bottone compreso) | 840+706+237 · 825 capitoli |
| 152 | via la cornice iPhone dagli screenshot di grammatica/esercizi: ritaglio CSS in uniforme.css. **Taratura**: se resta un filo di cornice, ritocca `--sp-zoom` (1.40) e `--sp-alto` (30%) nel blocco /*152*/ — un posto solo | 1 blocco css |
| 153 | pillola "Gramática ▾": l'accento (Á/Ă) alzava la riga su es/pt/ro — altezze normalizzate per tutte le sezioni | 1 regola css |
| 154 | "Ook interessant" fuori dal main toccava i bordi su mobile: ora colonna 640px centrata con aria laterale | 58 pagine lessen |
| 155 | i tre scatti (tappa · lettore · percorso) dentro ogni card u-appcta, lingua della pagina, con swap di lingua attivo | 237 card |

Ordine definitivo dei banner: titolo → testo → prezzo → **stelline** → **bottone**.
